    ...
    public partial class InitialCreate : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_GroupReaders", x => x.Id);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ExpectedDateOfDelivery = table.Column<DateTime>(type: "datetime2", nullable: true),
                    NameReader = table.Column<string>(type: "nvarchar(max)", nullable: false)
                },
                constraints: table =>
                {
